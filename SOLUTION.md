...
│  (Groq / Llama-3)    │                 │  (Python Rules Engine)    │
...
3. **Guardrail Interceptor:** Regex-based validation runs on both input (masking PII like credit cards) and output (guaranteeing compliance with Section 7 to prevent unauthorized discounts or bank detail collection).
