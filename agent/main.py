...
async def get_chat_ui():
    ...
    <body>
        ...
        <footer class="max-w-4xl mx-auto px-6 pb-6 flex flex-col items-center gap-4 mt-auto">
            <div class="text-sm text-slate-400 font-medium tracking-wide">
              Developed by Mohammed Thaher S
            </div>
            <div class="flex items-center gap-5">
              <a href="https://github.com/MohammedThaher01" target="_blank" rel="noreferrer" class="text-slate-500 hover:text-gray-900 transition-colors" aria-label="GitHub">
